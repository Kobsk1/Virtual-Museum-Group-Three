...
// Each artwork object contains: title, year, image URL, description, and sources
const artworks = [
    {
        title: "Kaganapan", // Name of the artwork
        year: "1952", // Year the artwork was created
...
A realistic observation of a strained spine and flexed abdominal muscles is revealed by the side view, indicating a nine-month wait.`,
        source: "https://epa.culturalcenter.gov.ph/3/82/2212/"
    },
    {
        ...
        description: `A well-known attraction in Baesa, Caloocan City, and other major cities with Eternal Gardens parks is the Transfiguration of Jesus Christ.
...
The Transfiguration encourages humanity's pursuit of enlightenment by symbolizing faith in God and eternal life.`,
        source: "https://eternalgardens.ph/transfiguration"
    },
    {
        title: "Kiss of Judas", 
        year: "1955", 
        image: "https://media.mutualart.com/Images/2015_11/26/06/060951652/a4a2ab48-6847-493e-81d5-b7d21d66cd9f_570.Jpeg", 
        description: `When Napoleon Abueva first entered the nation's art scene in the 1950s with The Kiss of Judas, a sculpture he created out of a single adobe block to represent treachery, he established his name as a master who could create timeless works from a variety of materials.
...
He later gained recognition as a "pioneering modernist in sculpture" and was the youngest recipient of the National Artist Prize in 1976.`,
        source: "https://www.abs-cbn.com/life/02/16/18/remembering-napoleon-abueva-the-father-of-modern-philippine-sculpture"
    },
    {
        title: "Fredesvinda", 
        year: "1981", 
        ...
        description: `At the 1st ASEAN Sculpture Symposium held at Fort Canning Hill in Singapore, Abueva's sculpture, Fredesvinda, was on display.
As the skeleton of a ship, it symbolizes ASEAN unity and cooperation.`,
    ...
    },
    {
        ...
        source: "https://guidetothephilippines.ph/destinations-and-attractions/blood-compact-shrine"
    },
    {
...
A lean groin highlighted by a plain cloth, constricted thighs and legs, chiseled ribmarks on a full chest compared to a depressed abdomen, and the delineation of recesses and complexity of muscle and sinew in the outstretched arms are all ways to interpret pain and forbearance.
The drooping head's downward movement is echoed by Christ's large palms, which convey a faint sense of stress.`,
        source: "https://epa.culturalcenter.gov.ph/3/82/2168/"
    },
    {
...
One side of the sculpture shows the Sermon on the Mount, while the other side shows a scene of a simple Christian community, with a nun instructing young children and a priest standing among his parishioners.`,
        source: "http://www.parishoftheholysacrifice.ph/brief-history/"
    }
